...
with open(file_name, 'w') as f:
    for y in range(50,1050,100):
        i = 0
        for x in range(50,1050,100):
            sum = 0
            for n in range(repetition):
                sinr = sc.compute_sinr(46,18,0,7,0,0.7,coor.Coordinate(x,y),coor.Coordinate(50,50),2,-104.5,6,363**-9,False,"URBAN_MACROCELL",25,1.5,20,20)
                sum += sinr
            sinr_medio = sum/repetition
            print("ue[{}]({},{}): {}".format(k,x,y, sinr_medio))
